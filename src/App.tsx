        ...
        <div className={`w-full max-w-md px-4 transition-all duration-300 ${
          ...
          <div className="relative">
            ...
            >
              ...
              {/* Slider Thumb */}
              <div 
                className={`absolute top-1/2 transform -translate-y-1/2 -translate-x-1/2 w-7 h-7 bg-emerald-700 rounded-full border-3 border-slate-900 shadow-lg transition-all duration-200 ${
                  isSliderDisabled 
                    ? 'cursor-not-allowed' 
